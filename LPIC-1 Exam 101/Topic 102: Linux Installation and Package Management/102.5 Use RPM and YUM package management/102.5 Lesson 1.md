...
1. Разделите следующие имена общедоступных библиотек на части:
...
2. Вы разработали часть программного обеспечения и хотите добавить в свою систему новый каталог общедоступной библиотеки (`/opt/lib/mylib`). Вы указываете его абсолютный путь в файле `mylib.conf`. 
* В какой каталог вы должны поместить этот файл? 
* Какую команду следует запустить, чтобы изменения полностью вступили в силу?

3. Какую команду вы бы использовали для вывода списка общедоступных библиотек, необходимых для `kill`?
